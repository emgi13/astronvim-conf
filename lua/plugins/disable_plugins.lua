---@type LazySpec[]
return {
  { "max397574/better-escape.nvim", enabled = false }, -- Not required as i have remapped capslock to esc
  { "windwp/nvim-ts-autotag", enabled = false }, -- This is messing with luasnip
