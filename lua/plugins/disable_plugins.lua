---@type LazySpec[]
return {
  { "https://github.com/max397574/better-escape.nvim", enabled = false }, -- Not required as i have remapped capslock to esc
  ...
  { "https://github.com/lervag/vimtex", enabled = false }, -- not required as telescope is available
